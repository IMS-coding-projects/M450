...
export default function CurrentReservation({ reservation }: { reservation?: Reservation }) {
    ...
    const isPrivate =
        !!reservation &&
        document.querySelector<HTMLInputElement>('#privateKey')?.value === reservation.privateKey;
    ...
    async function onEditSubmit(data: ReservationDTO) {
        ...
        try {
            ...
            toast.success('Reservation updated!', {
                description:
                    'The site will refresh automatically in 4.5 seconds to show the accurate information...',
                duration: 4500,
            });
            const url = new URL(window.location.href);
    ...
    async function handleDelete() {
        ...
        try {
            ...
            toast.success('Reservation deleted!', {
                description: 'Redirecting to home in 3 seconds...',
                duration: 3000,
            });
            const url = new URL(window.location.href);
            url.searchParams.delete('privateKey');
        ...
        return (
            <Card className="h-full w-full">
                <CardHeader>
                    ...
                    <CardDescription>
                        Please enter the provided keys on the Access Key Panel or create a new
                        Reservation
                    </CardDescription>
                    <CardAction>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    >
                                        <SelectValue
                                            defaultValue={reservation.startTime.substring(
                                                0,
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    >
                                        <SelectValue
                                            defaultValue={reservation.endTime.substring(
                                                0,
                                                reservation.endTime.length - 3
                                            )}
                                        />
                                    </SelectTrigger>
                                    <SelectContent>
    ...
    return (
        <>
            <Card className="h-full w-full">
                <CardHeader>
                    <CardTitle>Reservation for Room {reservation.room?.roomNumber}</CardTitle>
                    <CardDescription>
                        {reservation.date && (
                            <span>
                                ...
                                <>
                                    <HoverCard>
                                        <HoverCardTrigger asChild>
                                            <div>
                                                <Label
                                                    htmlFor={'privatekey-input-current'}
                                                ...
                                                <Input
                                                    ...
                                                    onClick={(e) => {
                                                        ...
                                                        navigator.clipboard
                                                            .writeText(reservation.privateKey)
                                                            .then();
                                                        toast.success(
                                        ...
                                        <HoverCardContent asChild>
                                            <Alert variant={'destructive'}>
                                                <AlertTitle
                                                    className={
                                                        'text-xs flex gap-1 text-destructive'
                                                    }
                                                >
                                                    <LucideTriangleAlert
                                                        size={30}
                                                ...
                                                <AlertDescription className={'text-xs'}>
                                                    It is used to securely access and manage your
                                                    reservations. Sharing it will allow others to
                                                    edit or delete your reservations.
                                                </AlertDescription>
                                            </Alert>
                                        </HoverCardContent>
                                    </HoverCard>
                                ...
                                <>
                                    <HoverCard>
                                        <HoverCardTrigger asChild>
                                            <div>
                                                <Label
                                                    htmlFor={'publickey-input-current'}
                                                    className={'cursor-pointer'}
                                                >
                                                    Public Key
                                                </Label>
                                                <Input
                                                    ...
                                                    onClick={(e) => {
                                                        (e.target as HTMLInputElement).select();
                                                        navigator.clipboard
                                                            .writeText(reservation.publicKey)
                                                            .then();
                                                        toast.success(
                                        ...
                                        >
                                            <Alert>
                                                ...
                                                <AlertDescription className={'text-xs'}>
                                                    Share your public key with others to allow them
                                                    to view your reservations without giving them
                                                    access to manage them. You can click on me to
